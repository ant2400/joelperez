...
(function (a) {
    ...
    a.supersized = function (t) {
        ...
        if (t.performance == 3) {
            ...
            arr = t.slides;
            for (var f, q, h = arr.length; h; f = parseInt(Math.random() * h), q = arr[--h], arr[h] = arr[f], arr[f] = q) {}
            t.slides = arr
        }
        ...
        a(window).load(function () {
            a("#supersized-loader").hide();
            k.fadeIn("fast");
            a("#controls-wrapper").show();
            if (t.thumbnail_navigation) {
                l - 1 < 0 ? prevThumb = t.slides.length - 1 : prevThumb = l - 1;
            ...
            if (t.slideshow && t.slides.length > 1) {
                if (t.slide_counter) {
                    ...
                    a("#slidecounter .totalslides").html(t.slides.length)
                }
                ...
                if (t.navigation) {
                    ...
                    if (a("#nextslide").attr("src")) {
                        ...
                        a("#nextslide").mouseup(function () {
                            a(this).attr("src", m + "forward_dull.png")
                        });
                    ...
                    if (a("#prevslide").attr("src")) {
                        ...
                        a("#prevslide").mouseup(function () {
                            a(this).attr("src", m + "back_dull.png")
                        });
        ...
        if (t.keyboard_nav) {
            ...
            a(document.documentElement).keyup(function (i) {
                ...
                if ((i.keyCode == 37) || (i.keyCode == 40)) {
                    if (a("#prevslide").attr("src")) {
                        a("#prevslide").attr("src", m + "back_dull.png")
                    }
                    if (b) {
                        return false
                    }
                    ...
                    if ((i.keyCode == 39) || (i.keyCode == 38)) {
                        if (a("#nextslide").attr("src")) {
                            a("#nextslide").attr("src", m + "forward_dull.png")
                        }
                        if (b) {
                            return false
                        }
        ...
        function r() {
            return k.each(function () {
                ...
                a(i).each(function () {
                    ...
                    var x;
                    if ((w <= t.min_height) && (j <= t.min_width)) {
                        if ((w / j) > u) {
                        ...
                        if (z) {
                            if (thisSlide.width() < j || thisSlide.width() < t.min_width) {
                                if (thisSlide.width() * u >= t.min_height) {
                                    thisSlide.width(t.min_width);
                                    thisSlide.height(thisSlide.width() * u)
                                } else {
                                    y()
                                }
                            }
                            ...
                            if (t.min_height >= w && !t.fit_landscape) {
                                if (j * u >= t.min_height || (j * u >= t.min_height && u <= 1)) {
                                    thisSlide.width(j);
                                    thisSlide.height(j * u)
                                } else {
                                    if (u > 1) {
                                        thisSlide.height(t.min_height);
                                        thisSlide.width(thisSlide.height() / u)
                                    } else {
        ...
        function o() {
            ...
            var u = t.slides;
            var j = k.find(".activeslide");
            j.removeClass("activeslide");
            if (j.length == 0) {
                j = k.find("a:last")
            }
            ...
            case 0:
                ...
                break;
            case 1:
                i.fadeTo(t.transition_speed, 1, function () {
                    p()
                });
                break;
            case 2:
        ...
        function g() {
            ...
            var i = j.prev().length ? j.prev() : a(k).find("a:last");
            var v = i.next().length ? i.next() : a(k).find("a:first");
            a(".prevslide").removeClass("prevslide");
            v.addClass("prevslide");
            l == 0 ? l = u.length - 1 : l--;
            if (t.performance == 1) {
            ...
            loadSlide = false;
            l - 1 < 0 ? loadSlide = u.length - 1 : loadSlide = l - 1;
            e = (t.slides[loadSlide].url) ? "href='" + t.slides[loadSlide].url + "'" : "";
